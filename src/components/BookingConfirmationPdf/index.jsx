        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.row}>Heure : {bookingData?.time}</Text>
                    <Text style={styles.row}>Durée : {bookingData?.duration} minutes</Text>
                    <Text style={styles.row}>Pilotes : {bookingData?.pilots}</Text>
                    <Text style={styles.row}>Prix : {bookingData?.price?.toFixed(2)} €</Text>
                </View>
                <View style={styles.section}>
